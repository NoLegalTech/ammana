 ...
 */
class Version20171017180333 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE invoice ADD quaderno_id VARCHAR(10) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE invoice DROP quaderno_id');
    }
}
