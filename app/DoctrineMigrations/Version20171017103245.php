 ...
 */
class Version20171017103245 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE protocol ADD price INT NOT NULL');
        $this->addSql('UPDATE protocol SET price = 25000');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE protocol DROP price');
    }
}
